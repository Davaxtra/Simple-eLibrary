          ...
          <div class="flex flex-wrap xl:items-center -mx-4">
            <div class="w-full md:w-1/2 py-4 px-4 md:mb-0">
              ...
              <div class="flex flex-wrap">
                @if (Auth::check())
                <div class="w-full md:w-auto py-1 md:py-0 md:mr-4"><a class="inline-block py-2 px-5 w-full text-base md:text-lg leading-4 text-green-50 font-medium text-center bg-blue-500 hover:bg-blue-600 rounded-md shadow" href="{{ route('book') }}" data-config-id="auto-txt-16-1">Find a Book</a></div>
                @else
