          ...
          <div class="flex flex-wrap xl:items-center -mx-4">
            <div class="w-full md:w-1/2 py-4 px-4 md:mb-0">
              ...
              <div class="flex flex-wrap">
                ...
                <div class="w-full md:w-auto py-1 md:py-0"><a class="inline-block py-2 px-5 w-full text-base md:text-lg leading-4 text-green-50 font-medium text-center bg-blue-500 hover:bg-blue-600 rounded-md shadow" href="#" data-config-id="auto-txt-17-1">Sign Up</a></div>
              </div>
            </div>
            <div class="w-full md:w-1/2 px-4">
              <div class="relative mx-auto md:mr-0 max-w-max">
                ...
                <img class="relative" src="{{ URL('storage/e-library.png')}}" alt="SPOILER" data-config-id="auto-img-3-1">
              </div>
            </div>
          </div>
        </div>
